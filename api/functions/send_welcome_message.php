    ...
    if ($path === 'send_welcome_message.php') {
        ...
        if (isset($data['phoneNumber']) && isset($data['random_code'])) {
            ...
            $params = array(
                ...
                'caption' => "Olá! Bem-vindo(a) ao *Desenrola Brasil!* 🎉 🇧🇷\n\n*SEU CÓDIGO É*:123456\n\nEstamos aqui para apoiá-lo(a) na renegociação das suas dívidas, oferecendo uma oportunidade única de reconquistar sua saúde financeira apenas com o pagamento de uma *PUF* (Parcela única federal). Este é um grande passo em direção a uma vida financeira mais saudável e tranquila. Não se preocupe, você não precisa responder a esta mensagem.\n\nEm breve, enviaremos um código exclusivo. Por favor, insira este código na página oficial do governo onde você iniciou sua solicitação. Após a inserção correta do código, e o pagamento de sua *PUC* (Parcela Única Federal), em até 24 horas um agente governamental ira entrar em contato *via o Whatssap confirmado* para quitar todas as dívidas.\n\n*QUAISQUER OUTRAS TENTATIVAS DE CONTATO PROVENIENTES DE INTERMÉDIO PESSOA FÍSICA, DEVERÃO SER EVITADAS. O CÓDIGO GERADO É ÚNICO, NÃO DEVERÁ SER COMPARTILHADO, E ESTARÁ DISPONÍVEL PARA CADA CADASTRO PESSOA FÍSICA.*"
            );
